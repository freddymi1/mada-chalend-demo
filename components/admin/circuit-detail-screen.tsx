    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="p-3 sm:p-6">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="font-semibold text-sm sm:text-base text-gray-900 dark:text-white truncate">
                    {Number(circuitDetail.duration)} jour(s) / {Number(circuitDetail.duration) - 1} nuit(s)
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    (E: {circuitDetail.nbrChild ?? 0} / A: {circuitDetail.nbrAdult ?? 0})
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border dark:border-gray-700 p-4 sm:p-6">
              ...
              <ul className="space-y-2 sm:space-y-3">
                {circuitDetail.included.map((item: any) => {
                  ...
                  return (
                    <li key={item.id} className="flex items-start space-x-2 sm:space-x-3">
          ...
          {/* Not Included */}
          {circuitDetail.notIncluded && circuitDetail.notIncluded.length > 0 && (
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border dark:border-gray-700 p-4 sm:p-6">
        ...
        {circuitDetail.itineraries && circuitDetail.itineraries.length > 0 && (
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border dark:border-gray-700 p-4 sm:p-6">
            <h3 className="font-semibold text-base sm:text-lg mb-4 sm:mb-6 text-gray-900 dark:text-white flex items-center">
              ...
              Itinéraire jour par jour ({circuitDetail.itineraries.length} jours)
            </h3>
            <div className="space-y-4 sm:space-y-6">
              {circuitDetail.itineraries.map((itinerary: any, index: number) => {
