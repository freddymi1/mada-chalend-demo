                  ...
                  <div className="relative">
                    ...
                    {formData.itinereryImage ? (
                      ...
                      <label className="flex flex-col items-center justify-center w-full h-40 sm:h-48 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-blue-500 transition">
                        ...
                        {isLoadingUpload ? (
                          <span className="text-xs sm:text-sm text-gray-500 mt-1">Uploading...</span>
                        ) : (
                          <span className="text-xs sm:text-sm text-gray-500 mt-1">Upload</span>
                        )}
                        <input
                          type="file"
                          className="hidden"
              ...
              <div className="bg-gray-50 p-3 sm:p-4 rounded-lg">
                ...
                <div className="space-y-3">
                  {formData.highlights.map((highlight, index) => (
                    <div key={index} className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 border-2 border-gray-200 p-3 rounded-lg">
                      <div className="flex flex-col gap-2 flex-1 w-full min-w-0">
                        <div className="flex items-center gap-2">
                          <span className="text-xs sm:text-sm font-medium flex-shrink-0">🇫🇷</span>
                          <input
                            type="text"
                            value={highlight.fr}
